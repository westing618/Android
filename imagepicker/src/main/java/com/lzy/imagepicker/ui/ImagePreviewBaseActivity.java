...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagepicker_image_preview);
        ...
        //初始化控件
        content = findViewById(R.id.image_preview_content);
//        Log.e("ImagePreviewBaseActivity","content:"+content);

        //因为状态栏透明后，布局整体会上移，所以给头部加上状态栏的margin值，保证头部不会被覆盖
        topBar = findViewById(R.id.image_preview_top_bar);
//        Log.e("ImagePreviewBaseActivity","topBar:"+topBar);
