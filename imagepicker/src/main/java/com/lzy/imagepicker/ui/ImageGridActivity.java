...
public class ImageGridActivity extends ImageBaseActivity implements
        ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener,
...
//        Log.e("flag","="+flag);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if(flag!=null){
                if(flag.equals("1")){
                    intent.putExtra("ImageGrid","1");
//                    Log.e("11111111111","1111111111111");
                }else if(flag.equals("2")){
                    intent.putExtra("ImageGrid","2");
//                    Log.e("2222222222","22222222222222");

                }else if(flag.equals("3")){
                    intent.putExtra("ImageGrid","3");
...
//            Intent intent = new Intent(ImageGridActivity.this, ImagePreviewActivity.class);//点击预览大图 在vovi手机上会蹦
...
//                        Log.e("4444444444","4444444444");
                        ...
                        intent.putExtra("ImageGrid","2");
//                        Log.e("55555555555555","5555555555");
                    }else if(flag.equals("3")){
                        intent.putExtra("ImageGrid","3");
//                        Log.e("6666666666","66666666666666");
                ...
                if(flag!=null){
                    if(flag.equals("1")){
                        intent.putExtra("ImageGrid","1");
//                        Log.e("7777777777777","7777777777");
                    }else if(flag.equals("2")){
                        intent.putExtra("ImageGrid","2");
//                        Log.e("888888888888","88888888888");
                    }else if(flag.equals("3")){
                        intent.putExtra("ImageGrid","3");
//                        Log.e("999999999999","999999999999");
                    }
                }
            ...
            if (resultCode == RESULT_OK && requestCode == ImagePicker.REQUEST_CODE_TAKE) {
                ...
                if (imagePicker.isCrop()) {
                    ...
                    if(flag!=null){
                        if(flag.equals("1")){
                            intent.putExtra("ImageGrid","1");
//                            Log.e("00000000000","11111111111");
                            SPUtil.put("ImageGrid", "1",this);
                        }else if(flag.equals("2")){
                            intent.putExtra("ImageGrid","2");
                            SPUtil.put("ImageGrid", "2",this);
//                            Log.e("0000000000000","2222222222222");
                        }else if(flag.equals("3")){
                            intent.putExtra("ImageGrid","3");
                            SPUtil.put("ImageGrid", "3",this);
//                            Log.e("00000000000000","333333333333");
                        }
                    }
