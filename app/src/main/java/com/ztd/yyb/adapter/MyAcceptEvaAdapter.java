 ...
 */
    ...
    public class MyAcceptEvaAdapter extends RecyclerView.Adapter<MyAcceptEvaAdapter.MainViewHolder> {

        LayoutInflater inflater;
        Context context;
        List<EvaluatearrayBean> leavedata;

        public MyAcceptEvaAdapter(Context context,List<EvaluatearrayBean> leavedata) {
            super();
