...
import com.ztd.yyb.bean.beanOrdSu.OrderSu;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MainViewHolder>{
    ...
    public SearchAdapter(Context context, List<OrderJjinfoBean> mTList,List<OrderYginfoBean> mYgList) {
...
//                            SuessBean suessBean = gson.fromJson(s, SuessBean.class);
//
//                            if (suessBean.getData().getSuccess().equals("1")) {
//
//                                context.startActivity(new Intent(context, GrabOrderSuccessActivity.class));
//
//                            } else if (suessBean.getData().getSuccess().equals("0")) {
//
//                                new SweetAlertDialog(context, SweetAlertDialog.ERROR_TYPE)
//                                        .setTitleText("提示")
//                                        .setContentText(suessBean.getMsg())
//                                        .show();
//
//                            }
                            OrderSu orderSu = gson.fromJson(s, OrderSu.class);

                            if (orderSu.getResult().equals("true")) {
                            ...
                            } else {//ygbmcstate：状态：0审核中   1认证通过   2认证未通过   3未认证


                                String ygbmcstate = orderSu.getData().getYgbmcstate();
                                String msg = "";
